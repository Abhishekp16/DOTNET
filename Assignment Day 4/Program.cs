...
namespace Day4assignment
{
    ...
    public abstract class Employee : IDbFunctions
    {
        ...
        public Employee(string Name = "Abhi", decimal Basic = 100, short DeptNo = 10)
        {
            EmpNo++;
            this.EMPNO += EmpNo;
            this.NAME = Name;
    ...
    public class Manager : Employee
    {
        ...
        public Manager(string Designation = "mgr", string Name = "Abhishek", decimal Basic = 1200, short DeptNo = 30) : base(Name, Basic, DeptNo)
        {
    ...
    {
        public CEO(string Name = "Abhi", decimal Basic = 100, short DeptNo = 10) : base(Name, Basic, DeptNo)
        {
        }
        #region Validations
        public override decimal BASIC
